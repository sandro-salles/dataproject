...
CREATE MATERIALIZED VIEW
person_nature_contact_phone_carrier as select distinct on (person.nature, cp.carrier_id)  person.nature || '_' || cp.carrier_id as id, person.nature, cp.carrier_id from person_person as person
	inner join
